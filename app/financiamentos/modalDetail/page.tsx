...
export default function ModalDetail({ onRequestClose, isOpen, optionDetail, financiamentoDetail, isView }: ModalOrderProps) {
  ...
  function obterTipoProfissao(codigo: number) {
    const tipoProfissao = BV_TIPOS_PROFISSOES.find(item => item.codigo === codigo)
  ...
  function obterSituacaoImovel(codigo: number) {
    const situacaoImovel = BV_SITUACAO_IMOVEL.find(item => item.codigo === codigo)
            ...
            <S.ContainerBox>
              ...
              <div className="grid grid-cols-2">
                ...
                <S.ContenteInfo>
                  ...
                  <S.TextInfo>{formatarTelefone(financiamentoDetail.telefone)}</S.TextInfo>
                </S.ContenteInfo>
                <S.ContenteInfo>
                  <S.TextInfo className="text-xs">CPF:</S.TextInfo>
                  <S.TextInfo>{formatarCPF(financiamentoDetail.cpf)}</S.TextInfo>
                </S.ContenteInfo>
                <S.ContenteInfo>
                  <S.TextInfo className="text-xs">Nascimento:</S.TextInfo>
                  <S.TextInfo>{formatarData(financiamentoDetail.dataNascimento)}</S.TextInfo>
                </S.ContenteInfo>
                <S.ContenteInfo>
            ...
            <S.ContainerBox>
              ...
              <div className="grid grid-cols-2">
                <S.ContenteInfo>
                  ...
                  <S.TextInfo>{obterProfissao(financiamentoDetail.profissao)}</S.TextInfo>
                </S.ContenteInfo>
                <S.ContenteInfo>
                ...
                <S.ContenteInfo>
                  ...
                  <S.TextInfo>{obterEstadoCivil(financiamentoDetail.estadoCivil)}</S.TextInfo>
                </S.ContenteInfo>
                <S.ContenteInfo>
                ...
                <S.ContenteInfo>
                  <S.TextInfo className="text-xs">Situação do imovel:</S.TextInfo>
                  <S.TextInfo>{obterSituacaoImovel(financiamentoDetail.situacaoImovel)}</S.TextInfo>
                </S.ContenteInfo>
                <S.ContenteInfo>
                  <S.TextInfo className="text-xs">Tipo de profissão:</S.TextInfo>
                  <S.TextInfo>{obterTipoProfissao(financiamentoDetail.tipoProfissao)}</S.TextInfo>
                </S.ContenteInfo>
                <S.ContenteInfo>
